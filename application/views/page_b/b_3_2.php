...
<div class="content-header">
  <div class="container">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark"> B.3.2 Pemasaran</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item active">Pemasaran</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
...
<div class="content">
  <div class="container">
    <div class="row">
      ...
      <?php endif; ?>
      <form action="<?php echo base_url();?>pemasaran/simpan_data" method="post" onsubmit="return konfirm()">
