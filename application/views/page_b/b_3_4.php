...
<div class="content-header">
  <div class="container">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark"> B.3.4 Consultant Fee</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item active">Consultant Fee</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
...
<div class="content">
  <div class="container">
    <div class="row">
      ...
      <?php endif; ?>
      <form action="<?php echo base_url();?>consultant_fee/simpan_data" method="post" onsubmit="return konfirm()">
