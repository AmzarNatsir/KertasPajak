...
<div class="content-header">
  <div class="container">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark"> B.3.4 Penyisihan Piutang Ragu-Ragu</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item active">Penyisihan Piutang Ragu-Ragu</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
...
<div class="content">
  <div class="container">
    <div class="row">
      ...
      <?php endif; ?>
      <form action="<?php echo base_url();?>penyisihan_piutang_ragu_ragu/simpan_data" method="post" onsubmit="return konfirm()">
